        ...
        <table class="table mt-4 table-bordered table-striped">
            ...
            @foreach ($transactions as $transaction)
                <tr>
                    ...
                    <td>{{ ($transaction->debitAccountHead->name== "Bank" || $transaction->debitAccountHead->name== "Cash") ? '-' : $transaction->amount}}</td>
                    <td>{{($transaction->creditAccountHead->name== "Bank" || $transaction->creditAccountHead->name== "Cash") ? '-' : $transaction->amount }}</td>
